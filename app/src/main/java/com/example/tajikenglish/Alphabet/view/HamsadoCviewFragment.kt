...
class HamsadoCviewFragment : Fragment(), View.OnClickListener {
    private lateinit var linearLayout: LinearLayout
    private lateinit var viewModel: HamsadotCviewViewModel

    var itemAlphabet: Int = 0

    override fun onAttach(context: Context) {
        super.onAttach(context)
        viewModel = ViewModelProvider(this).get(HamsadotCviewViewModel::class.java)
    }
    ...
    fun initializeViews(alphabets: AlphabetImageWordModel) {
        ...
        itemView.findViewById<TextView>(R.id.alpabetView).apply {
            ...
            setOnClickListener(this@HamsadoCviewFragment)
            setTag(alphabets)
        }
    ...
    companion object {
        fun newInstance(itemContact: AlphabetButtonModel): HamsadoCviewFragment {

            val fragment = HamsadoCviewFragment()
