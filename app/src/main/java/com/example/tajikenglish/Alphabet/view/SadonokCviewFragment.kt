...
import com.encom.dynamicview.vm.SadonokCviewViewModel
import com.example.tajikenglish.R
import java.io.InputStream


class SadonokCviewFragment : Fragment(), View.OnClickListener {
    private lateinit var linearLayout: LinearLayout
    private lateinit var viewModel: SadonokCviewViewModel

    var itemAlphabet: Int = 0

    override fun onAttach(context: Context) {
        super.onAttach(context)
        viewModel = ViewModelProvider(this).get(SadonokCviewViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.fragment_sadonokmain_view_fragment, container, false)
    ...
    fun initializeViews(alphabets: AlphabetImageWordModel) {
        ...
        itemView.findViewById<TextView>(R.id.alpabetView).apply {
            ...
            setOnClickListener(this@SadonokCviewFragment)
            setTag(alphabets)
        }
    ...
    companion object {
        fun newInstance(itemContact: AlphabetButtonModel): SadonokCviewFragment {

            val fragment = SadonokCviewFragment()
