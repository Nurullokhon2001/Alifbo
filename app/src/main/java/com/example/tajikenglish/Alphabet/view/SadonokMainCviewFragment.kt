...
class SadonokMainCviewFragment : Fragment(), View.OnClickListener {
    private lateinit var linearLayout: LinearLayout
    private lateinit var cviewViewModelAlphabet: SadonokMainCviewViewModel

    var indexarray: Int = 0

    override fun onAttach(context: Context) {
        super.onAttach(context)
        cviewViewModelAlphabet = ViewModelProvider(this).get(SadonokMainCviewViewModel::class.java)
    }
    ...
    override fun onClick(v: View?) {
        v?.let {
            ...
            requireActivity().supportFragmentManager.beginTransaction()
                .replace(R.id.fragment, SadonokCviewFragment.newInstance(alphabetCviewModel)).commit()
