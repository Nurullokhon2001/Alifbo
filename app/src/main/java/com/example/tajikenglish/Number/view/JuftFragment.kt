...
import com.encom.dynamicview.vm.JuftViewModel
import com.encom.dynamicview.vm.SadonokCviewViewModel
import com.example.tajikenglish.R
import java.io.InputStream


class JuftFragment : Fragment(), View.OnClickListener {
    private lateinit var linearLayout: LinearLayout
    private lateinit var viewModel: JuftViewModel

    var itemAlphabet: Int = 0

    override fun onAttach(context: Context) {
        super.onAttach(context)
        viewModel = ViewModelProvider(this).get(JuftViewModel::class.java)
    }
    ...
    fun initializeViews(alphabets: AlphabetImageWordModel) {
        ...
        itemView.findViewById<TextView>(R.id.alpabetView).apply {
            ...
            setOnClickListener(this@JuftFragment)
            setTag(alphabets)
        }
    ...
    companion object {
        fun newInstance(itemContact: AlphabetButtonModel): JuftFragment {

            val fragment = JuftFragment()
