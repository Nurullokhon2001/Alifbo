...
import com.encom.dynamicview.vm.Number2ViewModel
import com.example.tajikenglish.R


class Number2Fragment : Fragment(), View.OnClickListener {
    private lateinit var linearLayout: LinearLayout
    private lateinit var cviewViewModelAlphabet: Number2ViewModel

    var indexarray: Int = 0

    override fun onAttach(context: Context) {
        super.onAttach(context)
        cviewViewModelAlphabet = ViewModelProvider(this).get(Number2ViewModel::class.java)
    }
    ...
    override fun onClick(v: View?) {
        v?.let {
            ...
            requireActivity().supportFragmentManager.beginTransaction()
                .replace(R.id.fragment, NumberFragment.newInstance(alphabetCviewModel)).commit()
