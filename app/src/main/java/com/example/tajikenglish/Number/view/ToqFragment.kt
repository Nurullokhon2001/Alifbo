...
import com.encom.dynamicview.vm.HamsadotCviewViewModel
import com.encom.dynamicview.vm.Toq2ViewModel
import com.encom.dynamicview.vm.ToqViewModel
import com.example.tajikenglish.R
import java.io.InputStream


class ToqFragment : Fragment(), View.OnClickListener {
    private lateinit var linearLayout: LinearLayout
    private lateinit var viewModel: ToqViewModel

    var itemAlphabet: Int = 0

    override fun onAttach(context: Context) {
        super.onAttach(context)
        viewModel = ViewModelProvider(this).get(ToqViewModel::class.java)
    }
    ...
    fun initializeViews(alphabets: AlphabetImageWordModel) {
        ...
        itemView.findViewById<TextView>(R.id.alpabetView).apply {
            ...
            setOnClickListener(this@ToqFragment)
            setTag(alphabets)
        }
    ...
    companion object {
        fun newInstance(itemContact: AlphabetButtonModel): ToqFragment {

            val fragment = ToqFragment()
